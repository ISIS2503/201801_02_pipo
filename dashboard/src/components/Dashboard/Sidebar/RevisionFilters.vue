  ...
  <b-container>
    <b-row>
      <b-col>
        ...
        <md-icon v-on:click="select('not-revised')" class="md-size-2x">warning</md-icon>
      </b-col>
      <b-col v-on:click="select('revised')">
        <md-tooltip md-direction="bottom">Mostrar alarmas revisadas</md-tooltip>
        <md-icon class="md-size-2x">check_box</md-icon>
      </b-col>
      <b-col>
        <md-tooltip md-direction="bottom">Todas</md-tooltip>
        <h3>Todas</h3>
      </b-col>
    </b-row>
  </b-container>
...
.container .col {
  height: 6vh;
  border: 1px rgb(121, 14, 42) solid;
}
